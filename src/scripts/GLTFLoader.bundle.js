var THREE_GLTF_BUNDLE = (function (exports, three) {
	'use strict';
...
// Register to THREE namespace so existing code can use new THREE.GLTFLoader()
if (typeof THREE !== 'undefined' && THREE_GLTF_BUNDLE && THREE_GLTF_BUNDLE.GLTFLoader) {
  THREE.GLTFLoader = THREE_GLTF_BUNDLE.GLTFLoader;
  console.log('[GLTFLoader] Official GLTFLoader registered to THREE.GLTFLoader');
}
